...
request_parameters = '{"Engine":"standard","LanguageCode":"en-IN","OutputFormat":"ogg_vorbis","OutputS3BucketName":"testingbucket","Text":text,"TextType":"text","VoiceId":"Aditi"}'
request_parameters = '{'
request_parameters += '"OutputFormat":"mp3",'
request_parameters += '"OutputS3BucketName":"dhruvsnewbucket",'
request_parameters += '"Text":"'+text+'",'
request_parameters += '"VoiceId":"Hans"'
request_parameters += '}'
